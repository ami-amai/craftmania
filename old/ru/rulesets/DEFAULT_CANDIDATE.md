...
* **Ресурсы с Аттрибутами** - ресурсы, наличие которых в инвентаре на конец хода, дает бонусы в начале следующего хода
  * Аттрибуты - бонусы к существующим параметрам
    * ![Лечение](/img/items/x16/lime_dye.png) Лечение ![Сырое мясо](/img/items/x16/beef.png) (Увеличивает получаемое ХП с Разрушения предметов и Здоровье с Разрушения Еды на 1)
    ...
    * ![Урон](/img/items/x16/red_dye.png) Урон ![Стрела](/img/items/x16/arrow.png) (Увеличивает количество разрушаемых блоков Атакой на 1)
...
* **Еда** - дает большее количество ХП при разрушении, чем другие предметы
  * Сырое мясо ![Сырое мясо](/img/items/x16/beef.png) - **2 ХП**
  * Жаренное мясо ![Жаренное мясо](/img/items/x16/cooked_beef.png) - **5 + 3 Здоровья**
  * Хлеб ![Хлеб](/img/items/x16/bread.png) - **3 ХП + 1 Здоровье**
...
* **Здоровье** - запас ХП, который может быть получен в течении игры
  * Может быть восполнен частично Едой
