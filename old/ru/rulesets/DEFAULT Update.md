...
* **Крафт** - производится с ресурсами и требуемыми предметами на поле
  * Крафты из Личных ХП могут быть произведены внутри инвентаря
  * Остальное соответствует [Основному набору](#основной-набор)

* **Атака** - может быть выполнена одновременно с Перемещением по полю, атакующего предмета
  * требует некоторое количество Нейтральных ХП (в 2 раза меньше Личных ХП, но не меньше 1) в инвентаре, перед атакой удаляет их

  **Предметы**

  * Личный ХП - обычный ХП, принадлежащий конкретному игроку и имеющий его цвет
  * Нейтральный ХП - темно-серый ХП, который принадлежит сразу всем игрокам
    * На них доступны всем:
      * Крафты
      * Эффекты предметов
      * Атаки
      * Разрушение и удаление
    * При утрате Личных ХП, не помогает оставаться в игре
...
Требования | Ресурсы | Результат
-|-|-
2 Личных ХП | ![Дерево](/img/blocks/x32/oak_log.png) ![Сырое мясо](/img/items/x32/beef.png) | ![Жаренное мясо](/img/items/x32/cooked_beef.png)
